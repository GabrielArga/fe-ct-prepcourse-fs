...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
let ejercicoi = arrayOfNums.reduce(
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Si no. Si se pasa un argumento, simplemente retórnalo.
   // [PISTA]: "argumen se pasan argumentos retorna 0ts" es un arreglo.
   // Tu código:
if (arguments.length === 0)return 0;
if (arguments.length === 1)return [0];
let producto = 1;
for (let i = 0 ; i < arguments.length; i ++);{
producto = producto * arguments[0];
}
